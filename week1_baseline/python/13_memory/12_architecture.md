...
| **`tools/*`** (`file_system.py`, `shell.py`, `mud.py`) | Standard tool library (filesystem ops, sandboxed shell, MUD socket commands). Unchanged from `11_tui`. |
